[This text has a mouseover tooltip.][^2]
  ...
  Called on filesystem initialization, prior to all other functions.<sup>[:360](/spec/coffeescript_array_manipulations.spec.coffee#L16)</sup> Called only one time per each mount.<sup>[:284](/spec/coffeescript_array_manipulations.spec.coffee#L16)</sup><sup>[:586](/spec/coffeescript_array_manipulations.spec.coffee#L16)</sup> Always accepts only one input argument.<sup>[:1316](/spec/coffeescript_array_manipulations.spec.coffee#L16)</sup>
